...
def calculate_hypotenuse(base, height):
    """Calculate hypotenuse length of a triangle."""
...
def calculate_aspect(base, height):
    """Calculate the aspect of the triangle."""
    if base > height:
        return "wide"
    elif base < height:
        return "tall"
...
def triangle_master(base,
    ...
    """Returning the information graphically."""
    if return_diagram and return_dictionary:
        return return_diagram and return_dictionary
    elif return_diagram:
...
def wordy_pyramid():
    """Pyramid of words varying in length."""
    import requests
